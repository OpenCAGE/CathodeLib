...
namespace CATHODE.Scripting
{
    ...
    public static class EntityUtils
    {
        ...
        private static void ApplyDefaultParametersForFunction(Entity entity, FunctionType type, bool overwrite)
        {
            //TODO: hmm... should i have dumped States and Internals as well as Parameters? i think so...
            ...
            switch (type)
            {
                ...
                case FunctionType.LightReference:
                    ...
                    entity.AddParameter("volume_end_attenuation", new cFloat(-1f), ParameterVariant.PARAMETER, overwrite);
                ...
                case FunctionType.WEAPON_ImpactEffect:
                    ...
                    entity.AddParameter("SafeDistant", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                ...
                case FunctionType.EFFECT_ImpactGenerator:
                    ...
                    entity.AddParameter("min_distance", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("distance", new cFloat(3f), ParameterVariant.PARAMETER, overwrite);
                ...
                case FunctionType.EFFECT_EntityGenerator:
                    ...
                    entity.AddParameter("count", new cInteger(1), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("spread", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("force_min", new cFloat(1f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("force_max", new cFloat(1f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("force_offset_XY_min", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("force_offset_XY_max", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("force_offset_Z_min", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("force_offset_Z_max", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("lifetime_min", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("lifetime_max", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("use_local_rotation", new cBool(false), ParameterVariant.PARAMETER, overwrite);
                    break;
                case FunctionType.EFFECT_DirectionalPhysics:
                ...
                case FunctionType.FloatModulateRandom:
                    ...
                    entity.AddParameter("switch_on_delay", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("switch_on_custom_frequency", new cFloat(1f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("switch_on_duration", new cFloat(1f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("switch_off_anim", new cEnum(EnumType.LIGHT_TRANSITION, 1), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("switch_off_custom_frequency", new cFloat(1f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("switch_off_duration", new cFloat(1f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("behaviour_anim", new cEnum(EnumType.LIGHT_ANIM, 1), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("behaviour_frequency", new cFloat(1f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("behaviour_frequency_variance", new cFloat(0.0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("behaviour_offset", new cFloat(0f), ParameterVariant.PARAMETER, overwrite);
                    entity.AddParameter("pulse_modulation", new cFloat(1f), ParameterVariant.PARAMETER, overwrite);
