namespace CATHODE.Enums
{
    ...
    {
        NONE = 0, 
        PLAYER_ONLY = (1 << CHARACTER_CLASS.PLAYER),
        ALIEN_ONLY = (1 << CHARACTER_CLASS.ALIEN),
        ANDROID_ONLY = (1 << CHARACTER_CLASS.ANDROID),
        CIVILIAN_ONLY = (1 << CHARACTER_CLASS.CIVILIAN), 
        SECURITY_ONLY = (1 << CHARACTER_CLASS.SECURITY),
        FACEHUGGER_ONLY = (1 << CHARACTER_CLASS.FACEHUGGER),
        INNOCENT_ONLY = (1 << CHARACTER_CLASS.INNOCENT),
        ANDROID_HEAVY_ONLY = (1 << CHARACTER_CLASS.ANDROID_HEAVY),
        MOTION_TRACKER = (1 << CHARACTER_CLASS.MOTION_TRACKER),
        MELEE_HUMAN_ONLY = (1 << CHARACTER_CLASS.MELEE_HUMAN),
        ...
        PLAYER_AND_ALIEN = (PLAYER_ONLY | ALIENS), 
        ALL = (1 << (CHARACTER_CLASS.MELEE_HUMAN + 1)) - 1, 
    ...
    {
        NONE = 0, 
        PLAYER = (1 << NAVIGATION_CHARACTER_CLASS.PLAYER), 
        ALIEN = (1 << NAVIGATION_CHARACTER_CLASS.ALIEN), 
        ANDROID = (1 << NAVIGATION_CHARACTER_CLASS.ANDROID), 
        HUMAN_NPC = (1 << NAVIGATION_CHARACTER_CLASS.HUMAN_NPC), 
        FACEHUGGER = (1 << NAVIGATION_CHARACTER_CLASS.FACEHUGGER), 
        HUMAN = (HUMAN_NPC | PLAYER), 
        HUMANOID_NPC = (HUMAN | ANDROID),
        HUMANOID = (HUMANOID_NPC | PLAYER), 
        ANDROID_AND_ALIEN = (ANDROID | ALIEN),
        PLAYER_AND_ALIEN = (PLAYER | ALIEN),
        ALL = (1 << (NAVIGATION_CHARACTER_CLASS.FACEHUGGER + 1)) - 1,
    ...
    {
        USE_CHARACTER_PIN = 0, 
        PLAYER_ONLY = CHARACTER_CLASS_COMBINATION.PLAYER_ONLY, 
        ALIEN_ONLY = CHARACTER_CLASS_COMBINATION.ALIEN_ONLY,
        ANDROID_ONLY = CHARACTER_CLASS_COMBINATION.ANDROID_ONLY, 
        CIVILIAN_ONLY = CHARACTER_CLASS_COMBINATION.CIVILIAN_ONLY, 
        SECURITY_ONLY = CHARACTER_CLASS_COMBINATION.SECURITY_ONLY,
        FACEHUGGER_ONLY = CHARACTER_CLASS_COMBINATION.FACEHUGGER_ONLY, 
        INNOCENT_ONLY = CHARACTER_CLASS_COMBINATION.INNOCENT_ONLY, 
        ANDROID_HEAVY_ONLY = CHARACTER_CLASS_COMBINATION.ANDROID_HEAVY_ONLY,
        MOTION_TRACKER = CHARACTER_CLASS_COMBINATION.MOTION_TRACKER, 
        MELEE_HUMAN_ONLY = CHARACTER_CLASS_COMBINATION.MELEE_HUMAN_ONLY, 
        ANDROIDS = CHARACTER_CLASS_COMBINATION.ANDROIDS, 
        ALIENS = CHARACTER_CLASS_COMBINATION.ALIENS,
        HUMAN_NPC = CHARACTER_CLASS_COMBINATION.HUMAN_NPC, 
        HUMAN = CHARACTER_CLASS_COMBINATION.HUMAN, 
        HUMANOID_NPC = CHARACTER_CLASS_COMBINATION.HUMANOID_NPC,
        HUMANOID = CHARACTER_CLASS_COMBINATION.HUMANOID, 
        ANDROIDS_AND_ALIEN = CHARACTER_CLASS_COMBINATION.ANDROIDS_AND_ALIEN, 
        PLAYER_AND_ALIEN = CHARACTER_CLASS_COMBINATION.PLAYER_AND_ALIEN, 
        ALL = CHARACTER_CLASS_COMBINATION.ALL, 
        USE_FILTER_PIN, 
