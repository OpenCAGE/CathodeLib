...
{
    /// <summary>
    /// DATA/ENV/x/WORLD/STATE_x/CRAWL_SPACE_SPOTTING_POSITIONS & SPOTTING_POSITIONS
    /// </summary>
    public class SpottingPositions : CathodeFile
    {
        public int XCells;
        public int ZCells;
        public float MinX;
        ...
        public SpottingPositions(string path) : base(path) { }
        public SpottingPositions(MemoryStream stream, string path = "") : base(stream, path) { }
        public SpottingPositions(byte[] data, string path = "") : base(data, path) { }
