...
namespace CATHODE.Assets.Utilities
{
    /*
     *
        ...
        public PAKReturnType Open(string FilePath)
        {
            ...
            switch (Path.GetFileName(FilePath).ToUpper())
            {
                ...
                case "REQUIREDSHADERS_DX11.PAK":
                    PAKHandler = new Shaders(FilePath);
